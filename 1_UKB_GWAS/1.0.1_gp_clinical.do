...
*** BURDA KALDIM 
gen ASD=0
foreach i in ".E2Z1" ".E2Z2" ".E2Z3" ".E2Z4" "9NNl." "E140." "E1400" "E1401" "E140z" "Eu84." "Eu840" "Eu841" "Eu845" "Eu84y" "Eu84z" "Ub1Tr" "Ub1Ts" "X00TM" "X00TN" "X00TP" "XabEY" "XE2v2"{
        replace ASD=2 if read_2=="`i'" | read_3=="`i'"
}
* Exclude these from controls: Childhood conduct disorder, Hyperactive behaviour
foreach i in ".1J9." "1J9.." "9N6q." "E14.." "E14y0" "E14y1" "E212." "E2122" "E212z" "Eu846" "Ub0hp" "X00S7" "X00TI" "Xa1c7" "XabEa" "XacF5" "XaesO" "XaIuT" "XE0s5" "XM0ag" {
        replace ASD=1 if ASD==0 & (read_2=="`i'" |  read_3=="`i'")
}

bysort eid: egen ASD_GP=max(ASD)
**********************************************************
...
**********************************************************
gen ALZ=0
foreach i in "Eu00." "Eu000" "Eu001" "Eu002" "Eu00z" "F110." "F1100" "F1101" "Fyu30" "X002x" "X002y" "X002z" "X0030" "X0031" "X0032" "X0033" "X003G" "XaIKB" "XaIKC" "XM0aH" {
        replace ALZ=2 if read_2=="`i'" | read_3=="`i'"
}

foreach i in "13Y7." ".F21Z" "XE17j" {
        replace ALZ=1 if ALZ==0 & (read_2=="`i'" |  read_3=="`i'")
}

bysort eid: egen ALZ_GP=max(ALZ)
**********************************************************
