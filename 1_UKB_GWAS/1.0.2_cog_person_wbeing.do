...
local cog_person_wbeing CP EA FAMSAT FINSAT FRIENDSAT LONELY MORNING NEURO RELIGATT RISK SELFHEALTH SWB WORKSAT
by partition, sort: summarize `cog_person_wbeing'


foreach partition in 1 2 3 {
    foreach var of varlist `cog_person_wbeing' {
