...
stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.0_prep_input_data.do \
	$UKBv3_crosswalk \
	partitions/UKB_part1_eid.txt \
	partitions/UKB_part2_eid.txt \
	partitions/UKB_part3_eid.txt \
	$UKB_pheno_data_1 \
	$UKB_pheno_data_2 \
	$UKB_pheno_data_3 \
	$UKB_covar_data \
	$UKB_withdrawn \
	$PGI_Repo/code/1_UKB_GWAS/1.0.0_prep_input_data.do.log 

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.1_gp_clinical.do $PGI_Repo/code/1_UKB_GWAS/1.0.1_gp_clinical.log $UKB_pheno_GP

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.2_cog_person_wbeing.do $PGI_Repo/code/1_UKB_GWAS/1.0.2_cog_person_wbeing.log 

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.3_psych.do $PGI_Repo/code/1_UKB_GWAS/1.0.3_psych.log

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.4_anthro_fertility.do $PGI_Repo/code/1_UKB_GWAS/1.0.4_anthro_fertility.log 

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.5_health.do $PGI_Repo/code/1_UKB_GWAS/1.0.5_health.log 

stata -b do $PGI_Repo/code/1_UKB_GWAS/1.0.6_substance.do $PGI_Repo/code/1_UKB_GWAS/1.0.6_substance.do.log 
