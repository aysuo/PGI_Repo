...
setwd("/disk/genetics/PGS/Aysu/PGS_Repo_pipeline/derived_data/10_Prediction/input/")

########################################################

#### HRS2 #####
cohort="HRS2"
RAND_path <- paste0("/disk/genetics/PGS/Aysu/PGS_Repo_pipeline/original_data/prediction_phenotypes/HRS/randhrs1992_2016v2.dta")
...
#### UKB ####
cohort="UKB"
pheno_data <- read.dta13("/disk/genetics/PGS/Aysu/PGS_Repo_pipeline/derived_data/10_Prediction/tmp/pgs_repo.dta")%>% 
