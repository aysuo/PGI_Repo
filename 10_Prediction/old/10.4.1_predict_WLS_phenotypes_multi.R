...
score_names <- gsub("PGS_WLS_", "", gsub("-multi_LDpred_p1.txt", "", WLS_files_all))
...
fwrite(
  ...
  paste0(
    getwd(),
    "/output/WLS_phenotypes_r2_multi.txt"
  )
)
