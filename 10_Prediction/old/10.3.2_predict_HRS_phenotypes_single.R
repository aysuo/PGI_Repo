...
score_names <- gsub("PGS_HRS2_", "", gsub("-single_LDpred_p1.txt", "", HRS_files_all))
...
fwrite(
  ...
  paste0(
    getwd(),
    "/output/HRS_bootstraps_single.txt"
  )
)
...
fwrite(
  ...
  paste0(
    getwd(),
    "/output/HRS_phenotypes_r2_single.txt"
  )
)
