...
merge 1:1 n_eid using "tmp/UKB.dta", keep(match using)
...
foreach partition in 1 2 3{
    ...
    ****************************************
    foreach var of varlist ASTHMA ASTECZRHI AUDIT BMI CANNABIS COPD CP CPD DEP DPW EA ECZEMA ///
        ...
        export delimited FID IID phenotype using "input/UKB`partition'/`var'.pheno", noq delim(" ") replace
