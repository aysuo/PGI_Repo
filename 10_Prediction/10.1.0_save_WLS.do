...
* Author: Joel Becker and Robel Alemu 
* WLS Codebooks: https://www.ssc.wisc.edu/wlsresearch/documentation/waves/
*----------------------------------------------------------------------------------*
...
* adhd - Has the selected non-normative child ever been diagnosed with ADHD?
*dropped for now as ADHD is only defined for respondent's child 
...
rename (z_ixt06rer z_jxt06rer) (startSmoke_2004 startSmoke_2011)
...
/*Alzheimer's disease - Has any biological parent or sibling had Alzheimer's disease?*/
rename (z_ixa09rec z_jxf09rer z_jxm09rer z_jxb09rer z_jxs09rer) (Alzheimers_parentsib_2004 Alzheimers_father_2011 Alzheimers_mother_2011 Alzheimers_brother_2011  Alzheimers_sister_2011)
...
*Breast cancer - two parts question (whether any cancer and which organ)
rename (z_gx348re z_gx350are) (anyCancer_2004 cancerType_2004) 
rename (z_hx348re z_hx350are z_hx350bre z_hx350cre) (anyCancer_2011 cancerType1_2011 cancerType2_2011 cancerType3_2011)
...
/**Diabetes*/
		...
		/*Diabetes - Has a doctor ever told Participant they have diabetes?*/
		rename z_hx342re diabetes_2011
		
		/*Diabetes - Type of diabetes Participant was diagnosed with*/
		rename z_hx363re type2diabetes_2011
...
/*heart attack or myocardial infraction - Did you have a heart attack or myocardial infarction?*/
rename z_gx352re heartattack_2004
rename z_hx352re heartattack_2011
...
* high-cholesterol - Has a medical professional ever said that you have high cholesterol?
rename z_ix146rer highcholesterol_2004
rename z_jx146rer highcholesterol_2011

/*High blood pressure (BP) - Has a medical professional ever said you have high blood pressure?*/
	rename z_mx101rer highBP_1992
	rename z_gx341re highBP_2004
	rename z_hx341re highBP_2011

/*Insomnia - Did you have two weeks or more when nearly every night you had trouble falling asleep?*/
rename (z_ru007re z_gu007re z_hu007re) (insomnia_1993 insomnia_2004 insomnia_2011)
...
* number of children everborn - neb
...
*Age at smoking initiation
replace startSmoke_2004 = . if startSmoke_2004 < 0  
replace startSmoke_2011 = . if startSmoke_2011 < 0 
...
*Alzheimer's disease - any parent or sibling
replace Alzheimers_parentsib_2004 = . if Alzheimers_parentsib_2004 < 0 
replace Alzheimers_parentsib_2004 = 0 if Alzheimers_parentsib_2004==2

replace Alzheimers_father_2011 = . if Alzheimers_father_2011 < 0 
replace Alzheimers_father_2011 = 0 if Alzheimers_father_2011==2

replace Alzheimers_mother_2011 = . if Alzheimers_mother_2011 < 0 
replace Alzheimers_mother_2011 = 0 if Alzheimers_mother_2011==2

replace Alzheimers_brother_2011 = . if Alzheimers_brother_2011 < 0 
replace Alzheimers_brother_2011 = 0 if Alzheimers_brother_2011==2

replace Alzheimers_sister_2011 = . if Alzheimers_sister_2011 < 0 
replace Alzheimers_sister_2011 = 0 if Alzheimers_sister_2011==2

gen Alzheimers_parentsib_2011=0 
replace Alzheimers_parentsib_2011=1 if Alzheimers_father_2011==1 | Alzheimers_mother_2011==1 | Alzheimers_brother_2011==1 | Alzheimers_sister_2011==1 

  *rename variables for ease of use in downstream scripts 
  rename (Alzheimers_parentsib_2004 Alzheimers_parentsib_2011) (alzheimers_2004 alzheimers_2011)
...
replace anyCancer_2004 = . if anyCancer_2004 < 0 
replace anyCancer_2004 = 0 if anyCancer_2004==2
replace cancerType_2004 = . if cancerType_2004 < 0 

replace anyCancer_2011 = . if anyCancer_2011 < 0 
replace anyCancer_2011 = 0 if anyCancer_2011==2
replace anyCancer_2011 = . if anyCancer_2011 < 0 

gen breastCancer_2004=0 
replace breastCancer_2004=1 if anyCancer_2004==1 & cancerType_2004==174

gen breastCancer_2011=0 
replace breastCancer_2011=1 if cancerType1_2011==174 | cancerType2_2011==174 | cancerType3_2011==174
...
*Diabetes - type-2 diabetes:  
		...
		*Diabetes - whether respondent has diabetes 
		replace diabetes_2011=. if diabetes_2011<0
		replace diabetes_2011=0 if diabetes_2011==2 
		
		*Diabetes - type of diabetes respondent has 
		replace type2diabetes_2011=. if type2diabetes_2011<0 
		replace type2diabetes_2011=0 if type2diabetes_2011==1 | ///
		type2diabetes_2011==3 | type2diabetes_2011==4 | type2diabetes_2011==5 | ///
		type2diabetes_2011==6 
		replace type2diabetes_2011=1 if type2diabetes_2011==2 
		
		*Type-2 diabetes - whether respondent has type-2 diabetes 
		replace type2diabetes_2011=0 if diabetes_2011==0 
...
*heart attach or myocardial infraction (to be used for coronary heart disease)
replace heartattack_2004=. if heartattack_2004<0 
replace heartattack_2004=0 if heartattack_2004==2 

replace heartattack_2011=. if heartattack_2011<0 
replace heartattack_2011=0 if heartattack_2011==2 
...
replace highBP_1992=. if highBP_1992<0 
replace highBP_1992=0 if highBP_1992==2 

replace highBP_2004=. if highBP_2004<0 
replace highBP_2004=0 if highBP_2004==2 

replace highBP_2011=. if highBP_2011<0 
replace highBP_2011=0 if highBP_2011==2 

*high_choleserol 
replace highcholesterol_2004=. if highcholesterol_2004<0
replace highcholesterol_2004=0 if highcholesterol_2004==2 

replace highcholesterol_2011=. if highcholesterol_2011<0
replace highcholesterol_2011=0 if highcholesterol_2011==2 

*Insomnia 
replace insomnia_1993 = . if insomnia_1993 < 0 
replace insomnia_1993 = 0 if insomnia_1993==2

replace insomnia_2004 = . if insomnia_2004 < 0 
replace insomnia_2004 = 0 if insomnia_2004==2

replace insomnia_2011 = . if insomnia_2011 < 0 
replace insomnia_2011 = 0 if insomnia_2011==2
...
* Number of children everborn since 1975 - NEB
gen NEB = NEB_since75
...
*Prostate cancer (185=Malignant neoplasm of prostate)
gen prostateCancer_2004=0 
replace prostateCancer_2004=1 if anyCancer_2004==1 & cancerType_2004==185

gen prostateCancer_2011=0 
replace prostateCancer_2011=1 if cancerType1_2011==185 | cancerType2_2011==185 | cancerType3_2011==185
...
*smoking cessation - whether former smoker
gen formerSmoker_1993=. 
replace formerSmoker_1993=0 if smokenow_1993==1
replace formerSmoker_1993=1 if eversmoke_1993==1 & smokenow_1993==0 

gen formerSmoker_2004=. 
replace formerSmoker_2004=0 if smokenow_2004==1
replace formerSmoker_2004=1 if eversmoke_2004==1 & smokenow_2004==0 

gen formerSmoker_2011=. 
replace formerSmoker_2011=0 if smokenow_2011==1
replace formerSmoker_2011=1 if eversmoke_2011==1 & smokenow_2011==0 
...
outsheet using "`phenoDirOut'/tmp/WLS_renamed.csv", replace comma nolabel
saveold "`phenoDirOut'/tmp/WLS_renamed.dta", replace version(12)

drop if id==.
gen age=122-yob
gen sex="M" if male==1
replace sex="F" if male==0
tostring id, replace
gen FID=id+"_"+id
gen IID=FID
export delimited FID IID sex age using "`phenoDirOut'/WLS.agesex", noq delim(" ") replace
