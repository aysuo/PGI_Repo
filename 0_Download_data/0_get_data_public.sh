...
#------------------------------------#
# Aragam et al - Coronary artery disease
# All
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90132001-GCST90133000/GCST90132315/GCST90132315_buildGRCh37.tsv -O Aragam-CAD-MultiAncestry-GCST90132315_buildGRCh37.tsv
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90132001-GCST90133000/GCST90132315/README.txt -O ReadMe/Aragam-CAD-MultiAncestry.txt

# EUR
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90132001-GCST90133000/GCST90132314/GCST90132314_buildGRCh37.tsv -O Aragam-CAD-EUR-GCST90132314_buildGRCh37.tsv
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90132001-GCST90133000/GCST90132314/README.txt -O ReadMe/Aragam-CAD-ReadMe.txt
...
#------------------------------------#
# Graham et al - low-density lipoprotein cholesterol (LDL-C), high-density lipoprotein cholesterol (HDL-C), triglycerides (TG), total cholesterol (TC), and non-high-density lipoprotein cholesterol (nonHDL-C).
# Trans-ancestry
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/README.txt -O ReadMe/Graham-BloodLipids-README.txt
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/with_BF_meta-analysis_AFR_EAS_EUR_HIS_SAS_HDL_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/with_BF_meta-analysis_AFR_EAS_EUR_HIS_SAS_LDL_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/with_BF_meta-analysis_AFR_EAS_EUR_HIS_SAS_TC_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/with_BF_meta-analysis_AFR_EAS_EUR_HIS_SAS_logTG_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/with_BF_meta-analysis_AFR_EAS_EUR_HIS_SAS_nonHDL_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/without_UKB_meta-analysis_AFR_EAS_EUR_HIS_SAS_HDL_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/without_UKB_meta-analysis_AFR_EAS_EUR_HIS_SAS_LDL_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/without_UKB_meta-analysis_AFR_EAS_EUR_HIS_SAS_TC_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/without_UKB_meta-analysis_AFR_EAS_EUR_HIS_SAS_logTG_INV_ALL_with_N_1.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/trans_ancestry/without_UKB_meta-analysis_AFR_EAS_EUR_HIS_SAS_nonHDL_INV_ALL_with_N_1.gz

# EUR
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/README.txt -O ReadMe/Graham-BloodLipidsEUR-README.txt
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/HDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/LDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/TC_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/logTG_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/nonHDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/without_UKB_HDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/without_UKB_LDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/without_UKB_TC_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/without_UKB_logTG_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
wget https://csg.sph.umich.edu/willer/public/glgc-lipids2021/results/ancestry_specific/without_UKB_nonHDL_INV_EUR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz
...
#------------------------------------#
# Mahajan et al. - T2D (2018, 2022) (unadjusted for BMI)
...
#------------------------------------#
# Mathieson et al. - Number ever born, childlessness
# Downloaded from https://doi.org/10.17863/CAM.88397
#------------------------------------#
...
#------------------------------------#
# Saunders et al 
# Age started smoking, Cigarettes per day, Drinks per week, Ever smoker, Smoking cessation
# Not using the multi-ancestry results for now - requires getting MDS estimates in target cohort
# wget https://conservancy.umn.edu/bitstream/handle/11299/241912/Multi_ancestry.zip
# wget https://conservancy.umn.edu/bitstream/handle/11299/241912/MDS_datafiles.zip
wget https://conservancy.umn.edu/bitstream/handle/11299/241912/EUR_stratified.zip
wget https://conservancy.umn.edu/bitstream/handle/11299/241912/EUR_stratified_without_UKB.zip
...
#------------------------------------#
# Wang - Physical activity
## EUR
# ReadMe
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90104001-GCST90105000/GCST90104341/README.txt 
# Data
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90104001-GCST90105000/GCST90104341/GCST90104341_buildGRCh37.tsv -O Wang-ACTIVITY-EUR-GCST90104341_buildGRCh37.tsv

## All ancestry
# ReadMe
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90104001-GCST90105000/GCST90104342/README.txt
# Data
wget https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90104001-GCST90105000/GCST90104342/GCST90104342_buildGRCh37.tsv -O Wang-ACTIVITY-MultiAncestry-GCST90104342_buildGRCh37.tsv
...
# Yengo 2022 - Height
wget https://cnsgenomics.com/data/giant_2022/README.txt -O ReadMe/Yengo2022_ReadMe.txt
...
#wget https://cnsgenomics.com/data/giant_2022/GIANT_HEIGHT_YENGO_2022_PGS_WEIGHTS_ALL.gz
wget https://cnsgenomics.com/data/giant_2022/GIANT_HEIGHT_YENGO_2022_PGS_WEIGHTS_EUR.gz
#wget https://cnsgenomics.com/data/giant_2022/excluding_UKB/GIANT_HEIGHT_YENGO_2022_GWAS_SUMMARY_STATS_ALL_excluding_UKB.gz
#wget https://cnsgenomics.com/data/giant_2022/excluding_UKB/GIANT_HEIGHT_YENGO_2022_GWAS_SUMMARY_STATS_EUR_excluding_UKB.gz
#------------------------------------#
